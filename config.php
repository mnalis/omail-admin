...
if (isset($cookie_omail_lang) && !$default_lang) { $default_lang = htmlentities($cookie_omail_lang); }
if (!isset($default_lang)) { $default_lang = $default_language; }       // default language
